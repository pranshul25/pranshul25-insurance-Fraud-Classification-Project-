...
Size of the Dataset: (1000,39) with Null values
...
* Best Model is built using two algorithms, "SVM" & "XGBoost"

* Both the algorithms are passed with the best parameters derived from GridSearch

* Calculated the AUC scores for both models and select the model with the best score
